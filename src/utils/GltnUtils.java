...
public class GltnUtils {
	...
	public static Map<String, Object> readBirth() {
		...
		String aDate = utils.GltnUtils.readString("Lutfen dogum tarihinizi (yyyy-mm-dd) formatinda giriniz:");
	...
	public static LocalDate readDate(String str) {
		...
		do {
			...
			try {
				...
				String aDate = utils.GltnUtils.readString(str + " tarihini (yyyy-mm-dd) formatinda giriniz:");
